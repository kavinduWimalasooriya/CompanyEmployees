...
namespace CompanyEmployees.Presentation.Controllers
{
    ...
    public class CompaniesController : ControllerBase
    {
        ...
        {
            if (company == null) return BadRequest("CompanyCreation object is null");
        ...
        {
            var result =await _service.CompanyService.CreateComapnyCollectionAsync(companyCollection);
